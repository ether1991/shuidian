...
<body>
	<div id="addFamilyNumUser_container">
		...
		<center>
			<h1>添加家属院住户信息</h1>
			<s:form action="familynum_FamilyUseradd" namespace="/" method="post">
				<s:textfield label="房间号" name="familynum.roomid"></s:textfield>
				<s:textfield label="住户姓名" name="familynum.peoplename"></s:textfield>
				<s:textfield label="水表读数" name="familynum.waternum" value=""></s:textfield>
				<s:textfield label="电表读数" name="familynum.elecnum" value=""></s:textfield>
