...
<body>
	<div id="inputData_container">
		...
		<div id="body">
			...
			<center>
				<s:form action="inputdata_hireshowDownPage" namespace="/" method="post">
					...
					<label>房间号</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<select name="inputdata.roomid">
						<s:iterator  value="hirenumList">
					...
					<s:textfield label="备注" name="beizhu" value=""></s:textfield>
			...
			<center>
				<table width="90%" border="1">
					...
					<tr>
						<td><s:property value="hirefee.date" />
						<td><s:property value="hirefee.roomid" /></td>
						<td><s:property value="hirefee.waternum" /></td>
						<td><s:property value="hirefee.waterfee" /></td>
						<td><s:property value="hirefee.elecnum" /></td>
						<td><s:property value="hirefee.elecfee" /></td>
						<td><s:property value="hirefee.roomfee" /></td>
						<td><s:property value="hirefee.cleanfee" /></td>
						<td><s:property value="hirefee.allfee" /></td>
						<%-- <td><s:a action="inputdata_modifyInput"><s:param name="familyfee11">${familyfee}</s:param>修改</s:a></td> --%>
						<td><s:form action="inputdata_hiremodifyInput">
