	...
	<div id="inputData_container">
		...
		<div id="body">
			<center>
				...
				<hr>
				<p>按照月份查询</p>
				<s:form action="hirefee_hirefeefindByDate" method="post">
					<s:textfield label="月份" name="date"  onfocus="HS_setDate(this)"></s:textfield>
					<s:submit value="确认查询"></s:submit>
				</s:form>
				<hr>
				<p>按照房间号查询</p>
				<s:form action="hirefee_hirefeefindByRoomid" method="post">
				...
				<hr>
				<p>查询所有历史数据</p>
				<s:form action="hirefee_hirefeeSelectAll" method="post">
					<s:submit value="确认查询"></s:submit>
				</s:form>
			</center>
		</div>
