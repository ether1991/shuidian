		...
		<div id="body">
			<center>
				...
				<table width="90%" border="1">
					...
					<tr>
						<td><s:property value="hireprice.price_water" /></td>
						<td><s:property value="hireprice.price_elec" /></td>
						<td><s:property value="hireprice.price_room" /></td>
					</tr>
				</table>
			</center>
			<center>
				<h2>修改单价</h2>
					<s:form action="hireprice_HirePriceUpdate?hireprice.id=1" method="post">
					<s:textfield label="水费单价" name="hireprice.price_water"></s:textfield>
					<s:textfield label="电费单价" name="hireprice.price_elec"></s:textfield>
					<s:textfield label="房租单价" name="hireprice.price_room"></s:textfield>
