		...
		<div id="body">
			<center>
				...
				<table width="90%" border="1">
					...
					<tr>
						<td><s:property value="price.waterprice" /></td>
						<td><s:property value="price.elecprice" /></td>
					</tr>
				</table>
			</center>
			<center>
				<h2>修改单价</h2>
				<s:form action="price_updatePrice?price.id=1" namespace="/user"
					method="post">
					<s:textfield label="水费单价" name="price.waterprice"></s:textfield>
					<s:textfield label="电费单价" name="price.elecprice"></s:textfield>
