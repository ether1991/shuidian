...
<body>
	<div id="familyNumList_container">
		...
		<div id="body">
			<center>
				<p>课题组列表</p>
				<a href="officenum_toofficenumaddpage">添加新用户</a> 
				<a href="user_toadminLoginSuccess">返回管理页面</a>
				<a href="officenum_toofficenumquery">查询信息</a>
				<table width="90%" border="1">
				 ...
				 <s:iterator begin="1" end="page.pages" var="page">
					<a
						href="officenum_officenumselectAll?page.page=<s:property value="#page"/>"><s:property
							value="#page" /></a> 
				</s:iterator>
			</center>
		</div>
