...
<body>
	<div id="inputData_container">
		...
		<div id="body">
			<center>
				<s:form action="officenum_inputfreespace" namespace="/" method="post">
					<s:textfield label="课题组名称" name="teamname"></s:textfield>
					<s:textfield label="优惠面积" name="freespace" value=""></s:textfield>
			...
			<center>
				<table width="90%" border="1">
					...
					<tr>
						<td><s:property value="officefee.date" />
						<td><s:property value="officefee.roomid" /></td>
						<td><s:property value="officefee.teamname" /></td>
						<td><s:property value="officefee.wateruse" /></td>
						<td><s:property value="officefee.waterfee" /></td>
						<td><s:property value="officefee.elecuse" /></td>
						<td><s:property value="officefee.elecfee" /></td>
						<td><s:property value="officefee.spacefee" /></td>
						<td><s:property value="officefee.cleanfee" /></td>
						<td><s:property value="officefee.allteamfee" /></td>
						<%-- <td><s:a action="inputdata_modifyInput"><s:param name="familyfee11">${familyfee}</s:param>修改</s:a></td> --%>
						<td><s:form action="inputdata_officemodifyInput">
								<s:hidden name="inputdata.roomid"></s:hidden>
								<s:hidden name="inputdata.date"></s:hidden>
								<s:hidden name="teamname"></s:hidden>
