	...
	<div id="inputData_container">
		...
		<div id="body">
			<center>
				...
				<hr>
				<p>按照课题组名称</p>
				<s:form action="officenum_officenumSelectByTeamname" method="post">
					<s:textfield label="课题组名称" name="officenum.teamname"></s:textfield>
					<s:submit value="确认查询"></s:submit>
				</s:form>
				<hr>
				<p>按照房间号查询</p>
				<s:form action="officenum_officenumSelectByroomid" method="post">
					<s:textfield label="房间号码" name="officenum.roomid"></s:textfield>
					<s:submit value="确认查询"></s:submit>
				</s:form>
			</center>
		</div>
