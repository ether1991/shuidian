	...
	<div id="inputData_container">
		...
		<div id="body">
			<center>
				...
				<hr>
				<!--<p>按照月份查询</p>
				<s:form action="familyfee_familyfeeSelectBound" method="post">
					<s:textfield label="开始月份" name="datebound.start"  onfocus="HS_setDate(this)"></s:textfield>
					<s:textfield label="终止月份" name="datebound.end"  onfocus="HS_setDate(this)"></s:textfield>
					<s:submit value="确认查询"></s:submit>
				</s:form>
				<hr>-->
				<p>按照房间号查询</p>
				<s:form action="familyfee_familyfeeSelectByRoomId" method="post">
					...
					<select name="roomid">
						<s:iterator  value="familyfeeList">
