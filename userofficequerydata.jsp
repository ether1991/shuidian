	...
	<div id="inputData_container">
		...
		<div id="body">
			<center>
				...
				<hr>
				<p>按照月份查询</p>
				<s:form action="officefee_officefeeSelectByDate" method="post">
					<s:textfield label="月份" name="date"  onfocus="HS_setDate(this)"></s:textfield>
					<s:submit value="确认查询"></s:submit>
				</s:form>
				<hr>
				<p>按照房间号查询</p>
				<s:form action="officefee_officefeeSelcetByRoomid" method="post">
					<s:textfield label="房 间 号" name="roomid" value=""></s:textfield>
					<s:submit value="确认查询"></s:submit>
				</s:form>
				<hr>
				<p>按照课题组名称查询</p>
				<s:form action="officefee_officefeeSelectByTeamname" method="post">
					<s:textfield label="课题组名称" name="teamname" value=""></s:textfield>
					<s:submit value="确认查询"></s:submit>
				</s:form>
				<hr>
				<p>查询所有</p>
				<s:form action="officefee_officefeeSelectAll" method="post">
					<s:submit value="确认查询"></s:submit>
				</s:form>
					<hr>
